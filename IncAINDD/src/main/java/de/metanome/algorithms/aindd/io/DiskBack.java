...
public class DiskBack {
    ...
    public  void writeToDisk(String bucketFilePath, HashSet<String> values){
        ...
        System.out.println("WRITE PATH = [" + bucketFilePath + "]");
    ...
    public  String getFilePath(String colName, int partID) {
        ...
        return partID < 0 ? tempFolder.getPath() + File.separator + safeColName : tempFolder.getPath() + File.separator + safeColName + "_" + partID;
    }
}
